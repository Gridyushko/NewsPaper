...
SECRET_KEY = 'django-insecure-z94q=&9l4w6n!9e74m*51rvk&#nm7343j2tp+k8yl6c#(k&ucg'
...
EMAIL_PORT = 465
EMAIL_HOST_USER = 'grikeit'  # ваше имя пользователя, например, если ваша почта user@yandex.ru, то сюда надо писать user, иными словами, это всё то что идёт до собаки
EMAIL_HOST_PASSWORD = 'keitgri'  # пароль от почты
EMAIL_USE_SSL = True
DEFAULT_FROM_EMAIL = 'grikeit@yandex.ru'
